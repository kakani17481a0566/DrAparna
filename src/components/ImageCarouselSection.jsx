            ...
            <div className="container mx-auto max-w-[1600px]">
                ...
                {(title || subtitle) && (
                    <div className="text-center mb-12 animate-fade-up">
                        {title && (
                            <h2 className="font-serif text-3xl md:text-5xl font-bold mb-4 text-dr-dark-purple">
                                {title}
                            </h2>
                        )}
                        {subtitle && (
                            <p className="font-serif text-lg md:text-xl text-dr-accent font-semibold max-w-4xl mx-auto">
                                {subtitle}
                            </p>
                        )}
                    </div>
