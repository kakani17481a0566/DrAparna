                ...
                <div className="flex flex-col lg:flex-row gap-6">
                    ...
                    <div className="lg:w-1/2 flex">
                        <div className="relative w-full overflow-hidden shadow-lg group flex-grow">
                            ...
                            />
                            <div className="absolute bottom-4 left-4 bg-dr-accent text-white font-woodford font-bold px-4 py-2 text-sm md:text-base uppercase tracking-wider z-10">
                    ...
                    <div className="lg:w-1/2 flex flex-col gap-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 flex-1">
                            ...
                            <div className="relative w-full h-full overflow-hidden shadow-lg group">
                                ...
                                />
                                <div className="absolute bottom-4 left-4 bg-dr-accent text-white font-woodford font-bold px-3 py-1.5 text-xs md:text-sm uppercase tracking-wider z-10">
                                    With Tribals
                                </div>
                            </div>
